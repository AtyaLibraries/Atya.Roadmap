# ATYA-111 — Verify and import the reproducible read-only audit evidence bundle
...
The source analyses do not ship the repository commits, settings/API exports, NuGet responses, timestamps, and file hashes needed to replay every material finding.

## Root cause

Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. The source analyses do not ship the repository commits, settings/API exports, NuGet responses, timestamps, and file hashes needed to replay every material finding.

## Desired outcome

Capture a sanitized, immutable evidence index for every managed and requested repository with ref/commit, retrieval time, cited-file hash, branch/tag/release/package metadata, and live-setting exports; keep secrets and private data out of public artifacts.
...
2. Capture a sanitized, immutable evidence index for every managed and requested repository with ref/commit, retrieval time, cited-file hash, branch/tag/release/package metadata, and live-setting exports
3. keep secrets and private data out of public artifacts.
...
# Task-specific proof: Capture a sanitized, immutable evidence index for every managed and requested repository with ref/commit, retrieval time, cited-file hash, branch/tag/release/package metadata, and live-setting exports; keep secrets and private data out of public artifacts.
```
...
You are implementing ATYA-111 for the AtyaLibraries ecosystem. Work independently; do not assume you have read the original analyses or repository audit.

Task objective

Verify and import the reproducible read-only audit evidence bundle. Capture a sanitized, immutable evidence index for every managed and requested repository with ref/commit, retrieval time, cited-file hash, branch/tag/release/package metadata, and live-setting exports; keep secrets and private data out of public artifacts.
...
Root cause: Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. The source analyses do not ship the repository commits, settings/API exports, NuGet responses, timestamps, and file hashes needed to replay every material finding.
