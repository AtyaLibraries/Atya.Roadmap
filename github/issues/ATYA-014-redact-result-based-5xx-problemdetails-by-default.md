# ATYA-014 — Redact Result-based 5xx ProblemDetails by default
...
This issue tracks **Redact Result-based 5xx ProblemDetails by default**. Only the minimum public coordination information is included here. Verified details, affected trust-boundary evidence, and any reproduction material are retained privately by organization maintainers.

Private evidence reference: AUDIT-SEC-014
...
3. Implement the smallest dependency-ordered remediation in **ProblemDetails**.
...
Implement ATYA-014 for the AtyaLibraries ecosystem in repository **ProblemDetails**. Respect hard dependencies (ATYA-002), obtain AUDIT-SEC-014 through the private maintainer channel, and do not publish private evidence, credentials, logs, or exploit reproduction. Make a focused change with tests, migration notes, rollback guidance, and sanitized completion evidence.
