# ATYA-031 — Recover Build.Sdk publishing and bring its release metadata into policy
...
| Hard dependencies | ATYA-020; ATYA-121 |
...
This issue tracks **Recover Build.Sdk publishing and bring its release metadata into policy**. Only the minimum public coordination information is included here. Verified details, affected trust-boundary evidence, and any reproduction material are retained privately by organization maintainers.

Private evidence reference: AUDIT-SEC-031
...
3. Implement the smallest dependency-ordered remediation in **Atya.Build.Sdk**.
...
Implement ATYA-031 for the AtyaLibraries ecosystem in repository **Atya.Build.Sdk**. Respect hard dependencies (ATYA-020; ATYA-121), obtain AUDIT-SEC-031 through the private maintainer channel, and do not publish private evidence, credentials, logs, or exploit reproduction. Make a focused change with tests, migration notes, rollback guidance, and sanitized completion evidence.
