# ATYA-026 — Roll pinned workflows and security baselines across the fleet
...
| Hard dependencies | ATYA-019; ATYA-001; ATYA-124; ATYA-036 |
...
This issue tracks **Roll pinned workflows and security baselines across the fleet**. Only the minimum public coordination information is included here. Verified details, affected trust-boundary evidence, and any reproduction material are retained privately by organization maintainers.

Private evidence reference: AUDIT-SEC-026
...
Implement ATYA-026 for the AtyaLibraries ecosystem in repository **Atya.Roadmap**. Respect hard dependencies (ATYA-019; ATYA-001; ATYA-124; ATYA-036), obtain AUDIT-SEC-026 through the private maintainer channel, and do not publish private evidence, credentials, logs, or exploit reproduction. Make a focused change with tests, migration notes, rollback guidance, and sanitized completion evidence.
