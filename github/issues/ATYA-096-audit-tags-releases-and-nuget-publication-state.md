# ATYA-096 — Audit tags, releases, and NuGet publication state
...
Tags, GitHub releases, source ancestry, NuGet versions, symbol packages, provenance, and API baselines may disagree.

## Root cause

Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. Tags, GitHub releases, source ancestry, NuGet versions, symbol packages, provenance, and API baselines may disagree.

## Desired outcome

Build a read-only matrix for every publishable repository: tags and ancestry, release assets, NuGet versions/listing, symbols, SourceLink, SBOM/attestation, release notes, PackageId ownership, and expected next version.

## Affected scope

Primary owner: **Atya.Roadmap**. Audit-affected repositories or coordination scopes: Atya.Roadmap, AtyaLibraries, Atya.Build.Sdk, Serialization. Only the cited findings and their direct acceptance evidence are added; unaffected architecture remains unchanged.
...
2. Build a read-only matrix for every publishable repository: tags and ancestry, release assets, NuGet versions/listing, symbols, SourceLink, SBOM/attestation, release notes, PackageId ownership, and expected next version.
...
# Task-specific proof: Build a read-only matrix for every publishable repository: tags and ancestry, release assets, NuGet versions/listing, symbols, SourceLink, SBOM/attestation, release notes, PackageId ownership, and expected next version.
```
...
You are implementing ATYA-096 for the AtyaLibraries ecosystem. Work independently; do not assume you have read the original analyses or repository audit.

Task objective

Audit tags, releases, and NuGet publication state. Build a read-only matrix for every publishable repository: tags and ancestry, release assets, NuGet versions/listing, symbols, SourceLink, SBOM/attestation, release notes, PackageId ownership, and expected next version.

Exact repository/package scope

Owning repository: Atya.Roadmap. Primary owner: **Atya.Roadmap**. Audit-affected repositories or coordination scopes: Atya.Roadmap, AtyaLibraries, Atya.Build.Sdk, Serialization. Only the cited findings and their direct acceptance evidence are added; unaffected architecture remains unchanged.
...
Root cause: Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. Tags, GitHub releases, source ancestry, NuGet versions, symbol packages, provenance, and API baselines may disagree.
