# ATYA-104 — Enforce the master/development and default-branch policy
...
| Hard dependencies | ATYA-003; ATYA-090; ATYA-095; ATYA-103 |
...
Default branches and protections must consistently implement the accepted two-branch policy while allowing documented repository archetype exceptions.

## Root cause

Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. Default branches and protections must consistently implement the accepted two-branch policy while allowing documented repository archetype exceptions.

## Desired outcome

Apply approved default-branch, protection, promotion, merge-back, deletion-on-merge, required-check, and tag rules; leave only master and development as normal long-lived branches after verified migration.

## Affected scope

Primary owner: **Atya.Roadmap**. Audit-affected repositories or coordination scopes: Atya.Roadmap, platform, AtyaLibraries. Only the cited findings and their direct acceptance evidence are added; unaffected architecture remains unchanged.
...
2. Apply approved default-branch, protection, promotion, merge-back, deletion-on-merge, required-check, and tag rules
3. leave only master and development as normal long-lived branches after verified migration.
...
# Task-specific proof: Apply approved default-branch, protection, promotion, merge-back, deletion-on-merge, required-check, and tag rules; leave only master and development as normal long-lived branches after verified migration.
```
...
You are implementing ATYA-104 for the AtyaLibraries ecosystem. Work independently; do not assume you have read the original analyses or repository audit.

Task objective

Enforce the master/development and default-branch policy. Apply approved default-branch, protection, promotion, merge-back, deletion-on-merge, required-check, and tag rules; leave only master and development as normal long-lived branches after verified migration.

Exact repository/package scope

Owning repository: Atya.Roadmap. Primary owner: **Atya.Roadmap**. Audit-affected repositories or coordination scopes: Atya.Roadmap, platform, AtyaLibraries. Only the cited findings and their direct acceptance evidence are added; unaffected architecture remains unchanged.
...
Root cause: Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. Default branches and protections must consistently implement the accepted two-branch policy while allowing documented repository archetype exceptions.
...
Do not start mutation until these hard dependencies are accepted: ATYA-003, ATYA-090, ATYA-095, ATYA-103.
