# ATYA-024 — Replace the PAT dispatch chain with a GitHub App
...
This issue tracks **Replace the PAT dispatch chain with a GitHub App**. Only the minimum public coordination information is included here. Verified details, affected trust-boundary evidence, and any reproduction material are retained privately by organization maintainers.

Private evidence reference: AUDIT-SEC-024
