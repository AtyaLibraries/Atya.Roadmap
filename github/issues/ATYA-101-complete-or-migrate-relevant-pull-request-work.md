# ATYA-101 — Complete or migrate relevant pull-request work
...
| Hard dependencies | ATYA-092; ATYA-093 |
...
Relevant PR work must land safely or be reconstructed against current branches before source branches can be cleaned.

## Root cause

Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. Relevant PR work must land safely or be reconstructed against current branches before source branches can be cleaned.

## Desired outcome

For each approved PR disposition, repair checks/conflicts and complete it, or migrate the patch and rationale to a fresh ATYA-linked branch/PR; preserve authorship and close superseded PRs with links.

## Affected scope

Primary owner: **Atya.Roadmap**. Audit-affected repositories or coordination scopes: Atya.Roadmap, .github, Atya.Templates.NuGetPackage, BackgroundServices, github-workflows, Testing. Only the cited findings and their direct acceptance evidence are added; unaffected architecture remains unchanged.
...
2. For each approved PR disposition, repair checks/conflicts and complete it, or migrate the patch and rationale to a fresh ATYA-linked branch/PR
3. preserve authorship and close superseded PRs with links.
...
# Task-specific proof: For each approved PR disposition, repair checks/conflicts and complete it, or migrate the patch and rationale to a fresh ATYA-linked branch/PR; preserve authorship and close superseded PRs with links.
```
...
You are implementing ATYA-101 for the AtyaLibraries ecosystem. Work independently; do not assume you have read the original analyses or repository audit.

Task objective

Complete or migrate relevant pull-request work. For each approved PR disposition, repair checks/conflicts and complete it, or migrate the patch and rationale to a fresh ATYA-linked branch/PR; preserve authorship and close superseded PRs with links.

Exact repository/package scope

Owning repository: Atya.Roadmap. Primary owner: **Atya.Roadmap**. Audit-affected repositories or coordination scopes: Atya.Roadmap, .github, Atya.Templates.NuGetPackage, BackgroundServices, github-workflows, Testing. Only the cited findings and their direct acceptance evidence are added; unaffected architecture remains unchanged.
...
Root cause: Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. Relevant PR work must land safely or be reconstructed against current branches before source branches can be cleaned.
...
Do not start mutation until these hard dependencies are accepted: ATYA-092, ATYA-093.
