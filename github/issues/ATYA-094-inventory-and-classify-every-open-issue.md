# ATYA-094 — Refresh and verify every open-issue classification before migration
...
Useful issue content, duplicates, stale requests, and already-completed work are distributed across repositories without stable ecosystem IDs.

## Root cause

Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. Useful issue content, duplicates, stale requests, and already-completed work are distributed across repositories without stable ecosystem IDs.

## Desired outcome

Capture every open issue with repository, URL, labels, milestone, linked PRs, last activity, continuing value, overlap, and proposed ATYA mapping; preserve author context and acceptance details.
...
2. Capture every open issue with repository, URL, labels, milestone, linked PRs, last activity, continuing value, overlap, and proposed ATYA mapping
3. preserve author context and acceptance details.
...
# Task-specific proof: Capture every open issue with repository, URL, labels, milestone, linked PRs, last activity, continuing value, overlap, and proposed ATYA mapping; preserve author context and acceptance details.
```
...
You are implementing ATYA-094 for the AtyaLibraries ecosystem. Work independently; do not assume you have read the original analyses or repository audit.

Task objective

Refresh and verify every open-issue classification before migration. Capture every open issue with repository, URL, labels, milestone, linked PRs, last activity, continuing value, overlap, and proposed ATYA mapping; preserve author context and acceptance details.
...
Root cause: Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. Useful issue content, duplicates, stale requests, and already-completed work are distributed across repositories without stable ecosystem IDs.
