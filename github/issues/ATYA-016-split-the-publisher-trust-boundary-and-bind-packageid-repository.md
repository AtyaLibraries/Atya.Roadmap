# ATYA-016 — Split the publisher trust boundary and bind PackageId→repository
...
This issue tracks **Split the publisher trust boundary and bind PackageId→repository**. Only the minimum public coordination information is included here. Verified details, affected trust-boundary evidence, and any reproduction material are retained privately by organization maintainers.

Private evidence reference: AUDIT-SEC-016
...
Implement ATYA-016 for the AtyaLibraries ecosystem in repository **publisher**. Respect hard dependencies (ATYA-001), obtain AUDIT-SEC-016 through the private maintainer channel, and do not publish private evidence, credentials, logs, or exploit reproduction. Make a focused change with tests, migration notes, rollback guidance, and sanitized completion evidence.
