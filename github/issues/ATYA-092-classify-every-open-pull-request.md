# ATYA-092 — Refresh and verify every open pull-request classification before action
...
Open PRs may contain current, superseded, conflicting, or partially completed roadmap work and cannot be cleaned up safely without classification.

## Root cause

Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. Open PRs may contain current, superseded, conflicting, or partially completed roadmap work and cannot be cleaned up safely without classification.

## Desired outcome

Inventory every open draft and ready PR, checks/reviews/conflicts, linked issues, branch reachability, relevance, and final disposition: complete, rebase, migrate, supersede, or close.
...
2. Inventory every open draft and ready PR, checks/reviews/conflicts, linked issues, branch reachability, relevance, and final disposition: complete, rebase, migrate, supersede, or close.
...
# Task-specific proof: Inventory every open draft and ready PR, checks/reviews/conflicts, linked issues, branch reachability, relevance, and final disposition: complete, rebase, migrate, supersede, or close.
```
...
You are implementing ATYA-092 for the AtyaLibraries ecosystem. Work independently; do not assume you have read the original analyses or repository audit.

Task objective

Refresh and verify every open pull-request classification before action. Inventory every open draft and ready PR, checks/reviews/conflicts, linked issues, branch reachability, relevance, and final disposition: complete, rebase, migrate, supersede, or close.
...
Root cause: Fleet work accumulated across independent repositories without one stable ATYA identity and evidence-controlled retirement process. Open PRs may contain current, superseded, conflicting, or partially completed roadmap work and cannot be cleaned up safely without classification.
